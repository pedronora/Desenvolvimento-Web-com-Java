...
public class BanhoTest {
    public static void main(String[] args) {
        try {
            Banho b1 = new Banho(null, 60, 60, false, true, false);
        ...
        try {
            Banho b2 = new Banho("Banho", 0, 60, false, true, false);
        ...
        try {
            Banho b3 = new Banho("Banho", 60, 10, false, true, false);
        ...
        try {
            Banho b4 = new Banho("Banho Premium", 55.9f, 90, true, true, true);
        ...
        try {
            Banho b5 = new Banho("Banho c/ Higiêne Bocal", 55.9f, 75, false, true, true);
